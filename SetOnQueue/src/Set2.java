...
public class Set2<T> extends SetSecondary<T> {
    ...
    private static <T> void moveToFront(Queue<T> q, T x) {
        ...
        /*
         * Loop thru queue, if entry found, enqueue to end of queue. If not,
        ...
        /*
         * At end of loop, q would have only fonud entry, the found entry. So
         * append tempQ to q to make restored q with found entry at front.
         */
        q.append(tempQ);
    }
